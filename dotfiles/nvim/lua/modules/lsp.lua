...
local servers = {
    ...
    gremlh = {
        filetypes = { "text", "jsonc", "json", "yaml", "toml", "markdown" },
        cmd = { "/Users/dev/Codes/gremlh/target/debug/gremlh-lsp" },
        root_markers = { ".git" },
    },
}
...
for name, config in pairs(servers) do
    api.nvim_create_autocmd("FileType", {
        ...
        callback = function(args)
            if vim.fn.executable(config.cmd[1]) == 0 and name ~= "gremlh" then return end
